...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Zap Gas — Gas delivered, on demand" },
      { property: "og:description", content: "On-demand gas delivery, subscription refills and loyalty rewards across the West Rand." },
